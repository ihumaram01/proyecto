...
read -p "Ingresa la IP virtual de tu servicio (master_hostname): " MASTER_HOSTNAME

# Solicitar al usuario las IPs de los clientes permitidos
read -p "Ingresa las IPs de los servidores maestros separadas por espacio (ejemplo: 192.168.1.1 192.168.1.2): " ALLOWED_CLIENTS
